...
def get_locations_by_region(world: Optional[MultiWorld], player: Optional[int], worldstate) -> Dict[str, List[LocationData]]:
	...
	locations = {
		"Surface [Main]": [
			LocationData("Birth Seal Chest", 2359000, lambda state: s.attack_chest(state) and state.has_all({worldstate.get_seal_name('Birth Seal Chest'), "Helmet"}, player) and state.has_any({"Hermes' Boots", "Feather", "Bahamut Defeated"}, player), is_cursable=True, file_type='rcd', zones=[1,22], room=7, screen=1, object_type=0x2c, item_id=66),
			LocationData("deathv.exe Location", 2359001, lambda state: s.attack_forward(state) and (state.has("NPC: Xelpud", player) or s.glitch_raindrop(state)), file_type='rcd', zones=[1,22], room=4, screen=2, object_type=0x2f, item_id=96),
			LocationData("Feather Chest", 2359002, lambda state: s.attack_chest(state) and state.has('Serpent Staff', player) and combat.argus(state), is_cursable=True, file_type='rcd', zones=[1,22], room=0, screen=0, object_type=0x2c, item_id=53),
			LocationData("Map (Surface) Location", 2359003, lambda state: state.has("Hand Scanner", player), file_type='rcd', zones=[1], room=4, screen=2, object_type=0xb5, item_id=70),
			LocationData("Sacred Orb (Surface) Chest", 2359004, lambda state: state.has("Helmet", player) and state.has_any({"Hermes' Boots", "Bahamut Defeated"}, player) and (s.attack_above(state) or s.attack_shuriken(state) or s.attack_chakram(state) or s.attack_bomb(state) or s.attack_pistol(state) or (s.attack_s_above(state) and s.attack_chest(state)) or (s.attack_rolling_shuriken(state) and state.has("Bahamut Defeated", player))), is_cursable=True, file_type='rcd', zones=[1,22], room=8, screen=1, object_type=0x2c, item_id=69),
			LocationData("Shell Horn Chest", 2359005, lambda state: s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[1,22], room=4, screen=1, object_type=0x2c, item_id=38),
			LocationData("Surface Grail Tablet", None, lambda state: s.state_read_grail(state), True)
		],
		"Gate of Guidance [Main]": [
			LocationData("Ankh Jewel (Gate of Guidance) Chest", 2359006, lambda state: s.attack_main(state) or s.attack_shuriken(state) or s.attack_rolling_shuriken(state) or s.attack_chakram(state) or s.attack_caltrops(state) or s.attack_pistol(state), is_cursable=True, file_type='rcd', zones=[0], room=7, screen=1, object_type=0x2c, item_id=19),
			LocationData("Crucifix Chest", 2359007, lambda state: (s.attack_flare_gun(state) or (state.has('Flare Gun', player) and s.fairy_point_reachable(state))) and s.attack_chest(state) and state.has(worldstate.get_seal_name('Crucifix Chest/3 Lights'), player), is_cursable=True, file_type='rcd', zones=[0], room=1, screen=1, object_type=0x2c, item_id=42),
			LocationData("Holy Grail Chest", 2359008, lambda state: s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[0], room=4, screen=1, object_type=0x2c, item_id=40),
			LocationData("Map (Gate of Guidance) Chest", 2359009, lambda state: s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[0], room=3, screen=0, object_type=0x2c, item_id=70),
			LocationData("Sacred Orb (Gate of Guidance) Chest", 2359010, lambda state: s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[0], room=0, screen=1, object_type=0x2c, item_id=69),
			LocationData("Shuriken Location", 2359011, lambda state: s.attack_chest_any(state), file_type='rcd', zones=[0], room=2, screen=0, object_type=0x2f, item_id=8),
			LocationData("Treasures Chest", 2359012, lambda state: s.attack_chest_any(state) and state.has("Pepper", player), is_cursable=True, file_type='rcd', zones=[0], room=0, screen=0, object_type=0x2c, item_id=71),
		...
		"Gate of Guidance [Door]": [
			LocationData("yagostr.exe Chest", 2359013, lambda state: s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[0], room=5, screen=0, object_type=0x2c, item_id=88)
		],
		"Mausoleum of the Giants": [
			LocationData("Ankh Jewel (Mausoleum of the Giants) Chest", 2359014, lambda state: s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[2], room=6, screen=1, object_type=0x2c, item_id=19),
			LocationData("Map (Mausoleum of the Giants) Chest", 2359015, lambda state: s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[2], room=1, screen=1, object_type=0x2c, item_id=70),
			LocationData("Rolling Shuriken Location", 2359016, lambda state: s.attack_chest_any(state), file_type='rcd', zones=[2], room=3, screen=0, object_type=0x2f, item_id=9),
			LocationData("Sacred Orb (Mausoleum of the Giants) Chest", 2359017, lambda state: s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[2], room=7, screen=0, object_type=0x2c, item_id=69),
		...
		"Temple of the Sun [Main]": [
			LocationData("Ankh Jewel (Temple of the Sun) Chest", 2359018, lambda state: s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[3], room=7, screen=0, object_type=0x2c, item_id=19),
			LocationData("Knife Location", 2359019, lambda state: s.attack_shuriken(state) or (s.attack_chakram(state) and state.has_any({"Feather", "Grapple Claw"}, player)) or s.attack_bomb(state) or (s.attack_flare_gun(state) and s.attack_forward(state) and state.has("Feather", player)) or s.glitch_catpause(state), file_type='rcd', zones=[3], room=1, screen=2, object_type=0x2f, item_id=3),
			LocationData("Sacred Orb (Temple of the Sun) Chest", 2359020, lambda state: s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[3], room=4, screen=3, object_type=0x2c, item_id=69),
		...
		"Temple of the Sun [Top Entrance]": [
			LocationData("Map (Temple of the Sun) Chest", 2359021, lambda state: s.attack_chest(state) and s.sun_watchtower(state), is_cursable=True, file_type='rcd', zones=[3], room=0, screen=1, object_type=0x2c, item_id=70),
		],
		...
		"Temple of the Sun [West]": [
			LocationData("Isis' Pendant Chest", 2359022, lambda state: state.has("Buer Defeated", player) and s.state_literacy(state) and s.state_mobility(state) and (s.attack_above(state) or s.attack_s_above(state)), is_cursable=True, file_type='rcd', zones=[3], room=2, screen=0, object_type=0x2c, item_id=41),
			LocationData("Buer Defeated", None, lambda state: combat.buer(state), True)
		],
		"Temple of the Sun [East]": [
			LocationData("Bronze Mirror Chest", 2359023, lambda state: s.bronze_mirror_chest_logic(state), is_cursable=True, file_type='rcd', zones=[3], room=5, screen=0, object_type=0x2c, item_id=45),
			LocationData("Talisman Location", 2359024, lambda state: state.has("Viy Defeated", player), file_type='rcd', zones=[3], room=4, screen=2, object_type=0x2f, item_id=34)
		],
		"Spring in the Sky [Main]": [
			LocationData("Caltrops Location", 2359025, file_type='rcd', zones=[4], room=1, screen=0, object_type=0x2f, item_id=14),
			LocationData("Map (Spring in the Sky) Chest", 2359026, lambda state: s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[4], room=2, screen=1, object_type=0x2c, item_id=70),
			LocationData("Sacred Orb (Spring in the Sky) Chest", 2359027, lambda state: s.attack_chest_any(state) and state.has(worldstate.get_seal_name('Spring Sacred Orb Chest'), player), is_cursable=True, file_type='rcd', zones=[4], room=0, screen=0, object_type=0x2c, item_id=69),
		...
		"Spring in the Sky [Upper]": [
			LocationData("Glove Chest", 2359028, lambda state: state.has("Flooded Spring in the Sky", player) and s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[4], room=2, screen=0, object_type=0x2c, item_id=39),
			LocationData("Origin Seal Chest", 2359029, lambda state: state.has_all({'Helmet'}, player) and combat.nuckelavee(state) and (s.attack_forward(state) or (state.has("Feather", player) and s.attack_earth_spear(state))), is_cursable=True, file_type='rcd', zones=[4], room=5, screen=0, object_type=0x2c, item_id=65),
			LocationData("Scalesphere Chest", 2359030, lambda state: s.attack_chest(state) and state.has("Helmet", player), is_cursable=True, file_type='rcd', zones=[4], room=3, screen=0, object_type=0x2c, item_id=48),
		...
		"Inferno Cavern [Main]": [
			LocationData("bunplus.com Location", 2359031, lambda state: s.attack_forward(state), file_type='rcd', zones=[5], room=7, screen=0, object_type=0x2f, item_id=90),
			LocationData("Flare Gun Location", 2359032, lambda state: s.attack_forward(state), file_type='rcd', zones=[5], room=4, screen=0, object_type=0x2f, item_id=11),
			LocationData("Ice Cape Chest", 2359033, lambda state: s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[5], room=7, screen=1, object_type=0x2c, item_id=64),
			LocationData("Map (Inferno Cavern) Chest", 2359034, lambda state: s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[5], room=1, screen=0, object_type=0x2c, item_id=70),
			LocationData("Inferno Cavern Grail Tablet", None, lambda state: s.state_read_grail(state), True)
		],
		"Inferno Cavern [Pazuzu]": [
			LocationData("Chain Whip Location", 2359035, lambda state: combat.pazuzu(state), file_type='rcd', zones=[5], room=3, screen=0, object_type=0x2f, item_id=1)
		],
		"Inferno Cavern [Viy]": [
		...
		"Chamber of Extinction [Map]": [
			LocationData("Map (Chamber of Extinction) Chest", 2359040, lambda state: s.state_extinction_light(state) and s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[6], room=3, screen=0, object_type=0x2c, item_id=70)
		],
		...
		"Twin Labyrinths [Loop]": [
			LocationData("Ring Location", 2359041, lambda state: s.glitch_raindrop(state) or state.can_reach('Twin Labyrinths [Upper Left]', 'Region', player), file_type='rcd', zones=[7], room=2, screen=0, object_type=0x2f, item_id=47)
		],
		"Twin Labyrinths [Jewel]": [
			LocationData("Ankh Jewel (Twin Labyrinths) Chest", 2359042, lambda state: state.can_reach("Twin Labyrinths [Lower]", "Region", player) and state.can_reach("Twin Labyrinths [Upper Left]", "Region", player) and s.attack_flare_gun(state) and s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[7], room=11, screen=0, object_type=0x2c, item_id=19)
		],
		"Twin Labyrinths [Katana]": [
			LocationData("Katana Location", 2359043, lambda state: state.has_all({"Peryton Defeated", "Twin Statue"}, player) or s.glitch_catpause(state), file_type='rcd', zones=[7], room=11, screen=2, object_type=0x2f, item_id=6)
		],
		"Twin Labyrinths [Poison 1]": [
			LocationData("Map (Twin Labyrinths) Chest", 2359044, lambda state: state.has("Twin Poison Cleared", player) and s.attack_forward(state), is_cursable=True, file_type='rcd', zones=[7], room=2, screen=2, object_type=0x2c, item_id=70),
		...
		"Twin Labyrinths [Lower]": [
			LocationData("Sacred Orb (Twin Labyrinths) Chest", 2359045, lambda state: s.attack_chest(state) and (state.has("Zu Defeated", player) or s.glitch_raindrop(state) or (s.glitch_lamp(state) and state.has("Holy Grail", player))), is_cursable=True, file_type='rcd', zones=[7], room=4, screen=0, object_type=0x2c, item_id=69),
		...
		"Endless Corridor [1F]": [
			LocationData("Map (Endless Corridor) Chest", 2359046, lambda state: s.endless_oneway_open(state, worldstate) and s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[8], room=1, screen=0, object_type=0x2c, item_id=70),
			LocationData("Endless Corridor Grail Tablet", None, lambda state: s.state_read_grail(state), True)
		],
		"Endless Corridor [2F]": [
			LocationData("Key Sword Location", 2359047, lambda state: s.attack_chest(state), file_type='rcd', zones=[8], room=2, screen=1, object_type=0x2f, item_id=4)
		],
		"Endless Corridor [3F Upper]": [
			LocationData("Twin Statue Chest", 2359048, lambda state: s.attack_chest_any(state) and (state.has("Holy Grail", player) or s.glitch_raindrop(state) or (state.has("Key of Eternity", player) and (s.attack_forward(state) or (state.has("Feather", player) and (s.attack_flare_gun(state) or s.attack_earth_spear(state)))))), is_cursable=True, file_type='rcd', zones=[8,8], room=3, screen=0, object_type=0x2c, item_id=59)
		],
		"Endless Corridor [5F]": [
		...
		"Gate of Illusion [Middle]": [
			LocationData("Fairy Clothes Chest", 2359056, lambda state: s.state_key_fairy_access(state, False) and s.attack_below(state), is_cursable=True, file_type='rcd', zones=[10], room=6, screen=0, object_type=0x2c, item_id=55)
		],
		"Gate of Illusion [Grail]": [
			LocationData("Key of Eternity Chest", 2359057, lambda state: s.attack_chest(state) and state.has("Chi You Defeated", player), is_cursable=True, file_type='rcd', zones=[10], room=2, screen=2, object_type=0x2c, item_id=32),
		...
		"Gate of Illusion [Dracuet]": [
			LocationData("Map (Gate of Illusion) Chest", 2359058, lambda state: s.attack_forward(state), is_cursable=True, file_type='rcd', zones=[10], room=7, screen=1, object_type=0x2c, item_id=70)
		],
		"Graveyard of the Giants [West]": [
			LocationData("Gauntlet Chest", 2359059, lambda state: s.attack_chest_any(state) and state.has_all({"Feather", worldstate.get_seal_name('Gauntlet Chest')}, player), is_cursable=True, file_type='rcd', zones=[11], room=4, screen=1, object_type=0x2c, item_id=49),
			LocationData("Map (Graveyard of the Giants) Chest", 2359060, lambda state: s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[11], room=4, screen=0, object_type=0x2c, item_id=70),
			LocationData("mirai.exe Chest", 2359061, lambda state: s.attack_chest(state) and state.has("Feather", player), is_cursable=True, file_type='rcd', zones=[11], room=5, screen=0, object_type=0x2c, item_id=103),
			LocationData("Silver Shield Location", 2359062, lambda state: s.attack_below(state), file_type='rcd', zones=[11], room=1, screen=1, object_type=0x2f, item_id=17)
		],
		...
		"Temple of Moonlight [Upper]": [
			LocationData('Axe Location', 2359065, lambda state: (s.state_mobility(state) and s.attack_forward(state)) or (state.has('Grapple Claw', player) and (s.attack_shuriken(state) or s.attack_rolling_shuriken(state))), file_type='rcd', zones=[12], room=3, screen=0, object_type=0x2f, item_id=5),
			LocationData("Fruit of Eden Chest", 2359066, lambda state: s.attack_chest_any(state) and state.has("Hand Scanner", player) and state.can_reach("Temple of Moonlight [Lower]", "Region", player) and state.can_reach("Temple of Moonlight [Grapple]", "Region", player) and state.can_reach("Temple of Moonlight [Southeast]", "Region", player), is_cursable=True, file_type='rcd', zones=[12], room=2, screen=0, object_type=0x2c, item_id=58),
		...
		"Temple of Moonlight [Grapple]": [
			LocationData("Grapple Claw Chest", 2359067, lambda state: s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[12], room=0, screen=0, object_type=0x2c, item_id=44)
		],
		"Temple of Moonlight [Map]": [
			LocationData("Map (Temple of Moonlight) Chest", 2359068, lambda state: s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[12], room=1, screen=1, object_type=0x2c, item_id=70)
		],
		"Temple of Moonlight [Pyramid]": [
			#Not cursable because it's not a real chest
			LocationData("Philosopher's Ocarina Chest", 2359069, lambda state: state.has("Maternity Statue", player) and (state.has("Feather", player) or s.glitch_raindrop(state)), file_type='rcd', zones=[12], room=5, screen=0, object_type=0x2f, item_id=52)
		],
		"Temple of Moonlight [Southeast]": [
			LocationData("Serpent Staff Chest", 2359070, lambda state: s.attack_chest(state) and state.has("Book of the Dead", player) and combat.anubis(state), is_cursable=True, file_type='rcd', zones=[12], room=10, screen=0, object_type=0x2c, item_id=33),
		],
		"Tower of the Goddess [Lower]": [
			LocationData("Eye of Truth Chest", 2359071, lambda state: s.attack_chest_any(state) and state.can_reach("Tower of the Goddess [Lamp]", "Region", player) and state.has("Flooded Tower of the Goddess", player), is_cursable=True, file_type='rcd', zones=[13], room=3, screen=1, object_type=0x2c, item_id=46),
			LocationData("Flail Whip Location", 2359072, lambda state: (s.state_literacy(state) or s.glitch_catpause(state)) and (s.glitch_lamp(state) or state.has('NPC: Philosopher Samaranta', player)), file_type='rcd', zones=[13], room=5, screen=0, object_type=0x2f, item_id=2),
			LocationData("Map (Tower of the Goddess) Chest", 2359073, lambda state: s.attack_forward(state), is_cursable=True, file_type='rcd', zones=[13], room=1, screen=1, object_type=0x2c, item_id=70),
		...
		"Tower of the Goddess [Grail]": [
			LocationData("Plane Model Chest", 2359074, lambda state: state.has_all({'Eye of Truth', 'Flooded Tower of the Goddess'}, player) and combat.vimana(state) and (s.attack_chest(state) or (s.attack_flare_gun(state) and state.has("Feather", player))) and state.can_reach("Tower of the Goddess [Spaulder]", "Region", player) and state.can_reach("Tower of the Goddess [Lower]", "Region", player), is_cursable=True, file_type='rcd', zones=[13], room=6, screen=0, object_type=0x2c, item_id=51),
			LocationData("Spaulder Chest", 2359075, lambda state: s.attack_forward(state) and s.state_key_fairy_access(state, False) and (s.state_backside_warp(state) or state.has_all({"Feather", "Hermes' Boots"}, player)), is_cursable=True, file_type='rcd', zones=[13], room=7, screen=0, object_type=0x2c, item_id=62),
		...
		"Tower of Ruin [Southeast]": [
			LocationData("Sacred Orb (Tower of Ruin) Chest", 2359076, lambda state: s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[14], room=0, screen=2, object_type=0x2c, item_id=69)
		],
		"Tower of Ruin [Southwest]": [
			LocationData("Ankh Jewel (Tower of Ruin) Chest", 2359077, lambda state: (state.has("Feather", player) or state.can_reach("Tower of Ruin [Grail]", "Region", player)) and (s.attack_below(state) or s.attack_rolling_shuriken(state) or s.attack_bomb(state) or s.attack_caltrops(state) or (s.attack_earth_spear(state) and s.attack_forward(state)) or ((s.glitch_raindrop(state) or s.glitch_catpause(state)) and (s.attack_forward(state) or s.attack_vertical(state)))), is_cursable=True, file_type='rcd', zones=[14], room=1, screen=1, object_type=0x2c, item_id=19),
			LocationData("Earth Spear Location", 2359078, lambda state: state.has("Feather", player) or s.glitch_catpause(state), file_type='rcd', zones=[14], room=0, screen=0, object_type=0x2f, item_id=10),
		...
		"Tower of Ruin [Illusion]": [
			LocationData("Map (Tower of Ruin) Chest", 2359079, lambda state: s.attack_forward(state), is_cursable=True, file_type='rcd', zones=[14], room=5, screen=1, object_type=0x2c, item_id=70)
		],
		"Tower of Ruin [Top]": [
			LocationData("Djed Pillar Chest", 2359080, lambda state: s.nuwa_access(state, worldstate) and combat.nuwa(state) and s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[14], room=8, screen=0, object_type=0x2c, item_id=21)
		],
		...
		"Chamber of Birth [Northeast]": [
			LocationData("Perfume Chest", 2359081, lambda state: state.has("Mudmen Awakened", player) and s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[15], room=2, screen=0, object_type=0x2c, item_id=61),
			LocationData("Vessel Chest", 2359082, lambda state: state.has("Angel Shield", player) and s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[15], room=1, screen=1, object_type=0x2c, item_id=29)
		],
		"Chamber of Birth [Southeast]": [
			LocationData("Woman Statue Chest", 2359083, lambda state: s.attack_chest_any(state) and state.has_any({"Feather", "Grapple Claw"}, player), is_cursable=True, file_type='rcd', zones=[15], room=4, screen=0, object_type=0x2c, item_id=31)
		],
		"Chamber of Birth [West]": [
			LocationData("Map (Chamber of Birth) Chest", 2359084, lambda state: state.has_any({"Woman Statue", "Maternity Statue"}, player) and s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[16], room=1, screen=0, object_type=0x2c, item_id=70)
		],
		"Chamber of Birth [Grail]": [
			LocationData("Dimensional Key Chest", 2359085, lambda state: state.has_all({"Maternity Statue", "Dragon Bone", "Key of Eternity"}, player) and s.attack_forward(state) and (state.has("Cog of the Soul", player) or s.glitch_raindrop(state)), is_cursable=True, file_type='rcd', zones=[16], room=2, screen=1, object_type=0x2c, item_id=63),
			LocationData("Chamber of Birth Grail Tablet", None, lambda state: s.state_read_grail(state), True)
		],
		"Chamber of Birth [Skanda]": [
			LocationData("Pochette Key Chest", 2359086, lambda state: state.has("Skanda Defeated", player) and s.attack_chest_any(state), is_cursable=True, file_type='rcd', zones=[16], room=3, screen=1, object_type=0x2c, item_id=26),
		...
		"Dimensional Corridor [Grail]": [
			LocationData("Map (Dimensional Corridor) Chest", 2359087, lambda state: s.attack_chest(state) and state.has("Feather", player), is_cursable=True, file_type='rcd', zones=[17], room=0, screen=1, object_type=0x2c, item_id=70),
		...
		"Dimensional Corridor [Upper]": [
			LocationData("Angel Shield Location", 2359088, lambda state: state.has("Angel Shield Children Defeated", player) and state.has_any({"Feather", "Left Side Children Defeated"}, player) and (state.has("Dimensional Key", player) or s.glitch_catpause(state)), file_type='rcd', zones=[17], room=8, screen=0, object_type=0x2f, item_id=18),
			LocationData("Sacred Orb (Dimensional Corridor) Chest", 2359089, lambda state: state.has_all({"Feather", "Dimensional Key", worldstate.get_seal_name("Dimensional Sacred Orb Chest"), "Angel Shield Children Defeated"}, player) and s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[17], room=10, screen=0, object_type=0x2c, item_id=69),
			LocationData("Ankh Jewel (Dimensional Corridor) Chest", 2359090, lambda state: state.has("Mushussu Defeated", player) and s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[17], room=6, screen=0, object_type=0x2c, item_id=19),
			LocationData("Magatama Jewel Chest", 2359091, lambda state: state.has('Tiamat Defeated', player) and s.attack_chest(state), is_cursable=True, file_type='rcd', zones=[17], room=9, screen=0, object_type=0x2c, item_id=23),
		...
		"Gate of Time [Surface]": [
			LocationData("lamulana.exe Chest", 2359092, lambda state: s.attack_forward(state) or s.attack_flare_gun(state), is_cursable=True, file_type='rcd', zones=[21], room=0, screen=1, object_type=0x2c, item_id=104)
		],
