...
def get_locations_by_region(world: "LaMulanaWorld | None") -> dict[str, list[LocationData]]:
	...
	locations = {
		"Surface [Main]": [
			...
			LocationData("Surface Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True)
		],
		"Gate of Guidance [Main]": [
			...
			LocationData("Gate of Guidance Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True),
			LocationData('Amphisbaena Defeated', None, lambda state: s.attack_chest(state) and combat.amphisbaena(state) and s.has_ankh_jewel(state, 'Amphisbaena'), is_event=True)
		],
		...
		"Mausoleum of the Giants": [
			...
			LocationData("Mausoleum of the Giants Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True),
			LocationData('Sakit Defeated', None, lambda state: combat.sakit(state) and s.has_ankh_jewel(state, 'Sakit'), is_event=True)
		],
		"Temple of the Sun [Main]": [
			...
			LocationData('Maternity Statue', None, lambda state: state.has('Woman Statue', player), is_event=True),
			LocationData('Ellmac Defeated', None, lambda state: state.has('Holy Grail', player) and combat.ellmac(state) and s.has_ankh_jewel(state, 'Ellmac'), is_event=True)
		],
		...
		"Temple of the Sun [Grail]": [
			LocationData("Temple of the Sun Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True)
		],
		"Temple of the Sun [West]": [
			...
			LocationData("Buer Defeated", None, lambda state: combat.buer(state), is_event=True)
		],
		...
		"Spring in the Sky [Main]": [
			...
			LocationData("Flooded Temple of the Sun", None, lambda state: (s.attack_forward(state) and (s.state_water_swim(state, 3) or state.has('Holy Grail', player))) or (s.attack_vertical(state) and s.state_water_swim(state, 3)), is_event=True),
			LocationData("Spring in the Sky Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True)
		],
		"Spring in the Sky [Upper]": [
			...
			LocationData("Flooded Spring in the Sky", None, lambda state: state.has_all(("Helmet", worldstate.get_seal_name('Bahamut\'s Room')), player), is_event=True),
			LocationData('Bahamut Defeated', None, lambda state: state.has_all(('Helmet', worldstate.get_seal_name('Bahamut\'s Room')), player) and combat.bahamut(state) and s.has_ankh_jewel(state, 'Bahamut'), is_event=True)
		],
		"Inferno Cavern [Main]": [
			...
			LocationData("Inferno Cavern Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True)
		],
		...
		"Inferno Cavern [Viy]": [
			LocationData('Viy Defeated', None, lambda state: state.has('Holy Grail', player) and s.state_lava_swim(state, 5) and combat.viy(state) and s.has_ankh_jewel(state, 'Viy'), is_event=True)
		],
		"Chamber of Extinction [Main]": [
			...
			LocationData("Chamber of Extinction Grail Tablet", None, lambda state: s.state_extinction_light(state) and s.state_read_grail(state), is_event=True)
		],
		...
		"Chamber of Extinction [Left Main]": [
			LocationData("Lamp Recharge — Chamber of Extinction", None, lambda state: True, is_event=True)
		],
		"Chamber of Extinction [Magatama]": [
			LocationData("Ox-head & Horse-face Defeated", None, lambda state: combat.oxhead_horseface(state), is_event=True)
		],
		"Chamber of Extinction [Ankh Lower]": [
			...
			LocationData('Palenque Defeated', None, lambda state: state.has('Pochette Key', player) and state.can_reach_region('Chamber of Extinction [Teleport]', player) and state.can_reach_region('Chamber of Extinction [Left Main]', player) and combat.palenque(state) and s.has_ankh_jewel(state, 'Palenque'), is_event=True),
			LocationData("Hell Temple Unlocked", None, lambda state: s.hell_temple_requirements(state), is_event=True)
		],
		...
		"Twin Labyrinths [Poison 1]": [
			...
			LocationData("Twin Poison Cleared", None, lambda state: state.has("Twin Statue", player) or (state.can_reach_region("Twin Labyrinths [Poison 2]", player) and state.has('Holy Grail', player)), is_event=True)
		],
		"Twin Labyrinths [Upper Grail]": [
			LocationData("Twin Labyrinths (Front) Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True)
		],
		"Twin Labyrinths [Lower]": [
			...
			LocationData("Zu Defeated", None, lambda state: combat.zu(state), is_event=True),
			LocationData("Peryton Defeated", None, lambda state: combat.peryton(state), is_event=True),
			LocationData("Twin Labyrinths (Back) Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True),
			LocationData("Lamp Recharge — Twin Labyrinths", None, lambda state: True, is_event=True),
			LocationData('Baphomet Defeated', None, lambda state: state.has_all(('Zu Defeated', 'Peryton Defeated'), player) and combat.baphomet(state) and s.has_ankh_jewel(state, 'Baphomet'), is_event=True)
		],
		"Endless Corridor [1F]": [
			...
			LocationData("Endless Corridor Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True)
		],
		"Endless Corridor [2F]": [
		...
		"Endless Corridor [5F]": [
			LocationData("Backbeard & Tai Sui Defeated", None, lambda state: s.state_literacy(state) and combat.backbeard_tai_sui(state), is_event=True),
			LocationData("Lamp Recharge — Endless Corridor", None, lambda state: True, is_event=True)
		],
		"Shrine of the Mother [Main]": [
			...
			LocationData("Removed Shrine Skulls", None, lambda state: state.has_all(('Dragon Bone', 'yagostr.exe', 'yagomap.exe', 'Map (Shrine of the Mother)'), player), is_event=True)
		...
		'Gate of Illusion [Eden]': [
			LocationData("Illusion Unlocked", None, lambda state: state.has('Fruit of Eden', player), is_event=True)
		],
		"Gate of Illusion [Upper]": [
			...
			LocationData("Mudmen Awakened", None, lambda state: state.has_all(("Feather", "Cog of the Soul"), player) and s.attack_forward(state), is_event=True),
			LocationData("Recited All Mantras", None, lambda state: s.all_mantras(state), is_event=True)
		],
		...
		"Gate of Illusion [Grail]": [
			...
			LocationData("Gate of Illusion Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True),
			LocationData("Chi You Defeated", None, lambda state: (s.glitch_raindrop(state) or (state.can_reach_region("Mausoleum of the Giants", player) and state.has("Mini Doll", player) and s.state_literacy(state))) and (state.has(worldstate.get_seal_name('Chi You Seal'), player) or s.glitch_lamp(state)) and combat.chi_you(state), is_event=True)
		],
		...
		"Graveyard of the Giants [Grail]": [
			LocationData("Graveyard of the Giants Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True)
		],
		"Graveyard of the Giants [East]": [
			...
			LocationData("Lamp Recharge — Graveyard of the Giants", None, lambda state: True, is_event=True)
		],
		"Temple of Moonlight [Upper]": [
			...
			LocationData("Lamp Recharge — Temple of Moonlight", None, lambda state: True, is_event=True)
		],
		"Temple of Moonlight [Grail]": [
			LocationData("Temple of Moonlight Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True)
		],
		...
		"Tower of the Goddess [Grail]": [
			...
			LocationData("Tower of the Goddess Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True)
		],
		"Tower of the Goddess [Lamp]": [
			LocationData("Lamp Recharge — Tower of the Goddess", None, lambda state: True, is_event=True)
		],
		...
		"Tower of Ruin [Southwest]": [
			...
			LocationData("Thunderbird Defeated", None, lambda state: combat.thunderbird(state), is_event=True)
		],
		"Tower of Ruin [La-Mulanese]": [
			LocationData("Medicine Statue Open", None, lambda state: s.state_lamp(state) and s.attack_chest(state), is_event=True)
		],
		"Tower of Ruin [Grail]": [
			LocationData("Tower of Ruin Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True),
			LocationData("Lamp Recharge — Tower of Ruin", None, lambda state: True, is_event=True)
		],
		...
		"Tower of Ruin [Medicine]": [
			LocationData("Medicine of the Mind", None, lambda state: state.has_all(('Medicine Statue Open', 'Life and Death Mantras', 'mantra.exe', 'Djed Pillar', 'Vessel'), player) and state.can_reach_region('Tower of Ruin [Spirits]', player), is_event=True)
		],
		...
		"Chamber of Birth [Grail]": [
			...
			LocationData("Chamber of Birth Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True)
		],
		"Chamber of Birth [Skanda]": [
			...
			LocationData("Skanda Defeated", None, lambda state: state.can_reach_region("Chamber of Birth [Dance]", player) and state.has("Mudmen Awakened", player) and combat.skanda(state), is_event=True)
		],
		"Dimensional Corridor [Grail]": [
			...
			LocationData("Dimensional Corridor Grail Tablet", None, lambda state: s.state_read_grail(state), is_event=True),
			LocationData("Life and Death Mantras", None, lambda state: state.has_all(('NPC: Philosopher Fobos', 'Left Side Children Defeated', 'Hand Scanner', 'reader.exe'), player) and s.state_ancient_lamulanese(state), is_event=True)
		],
		"Dimensional Corridor [Upper]": [
			...
			LocationData("Left Side Children Defeated", None, lambda state: combat.left_side_children(state), is_event=True),
			LocationData("Right Side Children Defeated", None, lambda state: combat.right_side_children(state), is_event=True),
			LocationData("Angel Shield Children Defeated", None, lambda state: combat.angel_shield_children(state), is_event=True),
			LocationData("Ushumgallu Defeated", None, lambda state: state.has("Dimensional Key", player) and combat.ushumgallu(state), is_event=True),
			LocationData("Mushussu Defeated", None, lambda state: state.has_all(("Dimensional Key", "Angel Shield Children Defeated"), player) and (state.has_all(("Left Side Children Defeated", "Right Side Children Defeated"), player) or s.glitch_raindrop(state)) and combat.mushussu(state), is_event=True),
			LocationData('Tiamat Defeated', None, lambda state: state.has_all(('Dimensional Key', 'Left Side Children Defeated', 'Right Side Children Defeated', 'Angel Shield Children Defeated', 'Ushumgallu Defeated', 'Mushussu Defeated'), player) and combat.tiamat(state) and s.has_ankh_jewel(state, 'Tiamat'), is_event=True)
		],
