...
item_table: Dict[str, ItemData] = {
	...
	'Ankh Jewel (Amphisbaena)':         ItemData('Ankh Jewel', 2359021, progression=True, count=0, game_code=19, obtain_flag=0x853, obtain_value=1),
	'Ankh Jewel (Sakit)':               ItemData('Ankh Jewel', 2359022, progression=True, count=0, game_code=19, obtain_flag=0x854, obtain_value=1),
	'Ankh Jewel (Ellmac)':              ItemData('Ankh Jewel', 2359023, progression=True, count=0, game_code=19, obtain_flag=0x855, obtain_value=1),
	'Ankh Jewel (Bahamut)':             ItemData('Ankh Jewel', 2359024, progression=True, count=0, game_code=19, obtain_flag=0x856, obtain_value=1),
	'Ankh Jewel (Viy)':                 ItemData('Ankh Jewel', 2359025, progression=True, count=0, game_code=19, obtain_flag=0x857, obtain_value=1),
	'Ankh Jewel (Palenque)':            ItemData('Ankh Jewel', 2359026, progression=True, count=0, game_code=19, obtain_flag=0x858, obtain_value=1),
	'Ankh Jewel (Baphomet)':            ItemData('Ankh Jewel', 2359027, progression=True, count=0, game_code=19, obtain_flag=0x859, obtain_value=1),
	'Ankh Jewel (Tiamat)':              ItemData('Ankh Jewel', 2359028, progression=True, count=0, game_code=19, obtain_flag=0x85a, obtain_value=1),
	'Ankh Jewel (Mother)':              ItemData('Ankh Jewel', 2359029, progression=True, count=0, game_code=19, obtain_flag=0x85b, obtain_value=1),
