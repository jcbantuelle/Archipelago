...
item_table: Dict[str, ItemData] = {
	...
	'Ankh Jewel':                       ItemData('Subweapon', 2359020, progression=True, count=0, game_code=19, obtain_flag=0x852, obtain_value=1), #Adjust ankh jewel amount based on settings
	'Ankh Jewel (Amphisbaena)':         ItemData('Subweapon', 2359021, progression=True, count=0, game_code=19, obtain_flag=0x853, obtain_value=1),
	'Ankh Jewel (Sakit)':               ItemData('Subweapon', 2359022, progression=True, count=0, game_code=19, obtain_flag=0x854, obtain_value=1),
	'Ankh Jewel (Ellmac)':              ItemData('Subweapon', 2359023, progression=True, count=0, game_code=19, obtain_flag=0x855, obtain_value=1),
	'Ankh Jewel (Bahamut)':             ItemData('Subweapon', 2359024, progression=True, count=0, game_code=19, obtain_flag=0x856, obtain_value=1),
	'Ankh Jewel (Viy)':                 ItemData('Subweapon', 2359025, progression=True, count=0, game_code=19, obtain_flag=0x857, obtain_value=1),
	'Ankh Jewel (Palenque)':            ItemData('Subweapon', 2359026, progression=True, count=0, game_code=19, obtain_flag=0x858, obtain_value=1),
	'Ankh Jewel (Baphomet)':            ItemData('Subweapon', 2359027, progression=True, count=0, game_code=19, obtain_flag=0x859, obtain_value=1),
	'Ankh Jewel (Tiamat)':              ItemData('Subweapon', 2359028, progression=True, count=0, game_code=19, obtain_flag=0x85a, obtain_value=1),
	'Ankh Jewel (Mother)':              ItemData('Subweapon', 2359029, progression=True, count=0, game_code=19, obtain_flag=0x85b, obtain_value=1),
	...
	'Sacred Orb (Surface)':             ItemData('Sacred Orb', 2359139, progression=True, game_code=69, obtain_flag=0x864, obtain_value=1),
	'Sacred Orb (Gate of Guidance)':    ItemData('Sacred Orb', 2359140, progression=True, game_code=69, obtain_flag=0x865, obtain_value=1),
	'Sacred Orb (Mausoleum of the Giants)': ItemData('Sacred Orb', 2359141, progression=True, game_code=69, obtain_flag=0x866, obtain_value=1),
	'Sacred Orb (Temple of the Sun)':   ItemData('Sacred Orb', 2359142, progression=True, game_code=69, obtain_flag=0x867, obtain_value=1),
	'Sacred Orb (Spring in the Sky)':   ItemData('Sacred Orb', 2359143, progression=True, game_code=69, obtain_flag=0x868, obtain_value=1),
	'Sacred Orb (Tower of Ruin)':       ItemData('Sacred Orb', 2359144, progression=True, game_code=69, obtain_flag=0x869, obtain_value=1),
	'Sacred Orb (Chamber of Extinction)': ItemData('Sacred Orb', 2359145, progression=True, game_code=69, obtain_flag=0x86a, obtain_value=1),
	'Sacred Orb (Twin Labyrinths)':     ItemData('Sacred Orb', 2359146, progression=True, game_code=69, obtain_flag=0x86b, obtain_value=1),
	'Sacred Orb (Dimensional Corridor)':  ItemData('Sacred Orb', 2359147, progression=True, game_code=69, obtain_flag=0x86c, obtain_value=1),
	'Sacred Orb (Shrine of the Mother)':  ItemData('Sacred Orb', 2359148, progression=True, game_code=69, obtain_flag=0x86d, obtain_value=1),
